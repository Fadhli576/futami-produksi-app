...
@section('content')
        ...
        <div class="botol">
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong>{{ $pakai_botol ? number_format((($varian->trial_botol + $varian->jatuh_botol + $reject_produksi + $sampel - $unidentified) / $pakai_botol) * 100, 2) : 0 }}
                        %</strong>
                </div>
            </div>
        </div>
        <div class="cap">
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong
                        style="font-size: 20px">{{ $varian->masuk_cap || $varian->saldo_awal_cap ? $varian->masuk_cap + $varian->saldo_awal_cap : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                ...
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong
                        style="font-size: 20px">{{ $varian->jatuh_filling_cap ? $varian->jatuh_filling_cap : '0' }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                ...
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong style="font-size: 20px">{{ $varian->masuk_cap - $pakai_cap }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Loss Cap</strong>
                    <strong style="font-size: 20px">{{ $pakai_cap - $finish_good }}</strong>
                    <strong>{{ $pakai_cap ? number_format((($varian->trial_cap + $reject_produksi_cap + $sampel) / $pakai_cap) * 100, 2) : 0 }}
                        %</strong>
                </div>
            </div>
        </div>
        <div class="label">
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong
                        style="font-size: 20px">{{ $varian->masuk_label || $varian->saldo_awal_label ? $varian->masuk_label + $varian->saldo_awal_label : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Pakai Label</strong>
                    <strong style="font-size: 20px">{{ $varian->pakai_label ? $varian->pakai_label : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Saldo Akhir</strong>
                ...
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong style="font-size: 20px">
                        {{ $varian->saldo_label == '' ? '' : number_format(($varians = $varian->pakai_label - $finish_good / $varian->conversi_label) * 1, 2) }}
                    </strong>
                    <strong>
                        {{ $varian->saldo_label == '' ? 0 : number_format(($varians / $varian->pakai_label) * 100, 2) }}
                        %</strong>
                </div>
            </div>
        </div>
        <div class="karton">
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong
                        style="font-size: 20px">{{ $varian->masuk_karton || $varian->saldo_awal_karton ? $varian->masuk_karton + $varian->saldo_awal_karton : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Pakai Karton</strong>
                    <strong style="font-size: 20px">{{ $varian->terpakai_karton ? $varian->terpakai_karton : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Saldo Akhir</strong>
        ...
        <div class="lakban1">
            ...
            <div class="d-flex flex-wrap gap-3">
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong
                        style="font-size: 20px">{{ $varian->masuk_lakban || $varian->saldo_awal_lakban1 ? $varian->masuk_lakban + $varian->saldo_awal_lakban1 : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Pakai Lakban</strong>
                    <strong style="font-size: 20px">{{ $varian->terpakai_lakban ? $varian->terpakai_lakban : 0 }}</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Saldo Akhir</strong>
                ...
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong>{{ $varian->reject_lakban2 ? number_format(($varian->reject_lakban / $varian->pakai_lakban) * 100, 2) : 0 }}
                        %</strong>
                </div>
            </div>
        </div>
            ...
            <div class="lakban2">
                ...
                <div class="d-flex flex-wrap gap-3">
                    <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                        <strong style="font-size: 20px">Masuk Lakban + Saldo Awal</strong>
                        <strong
                            style="font-size: 20px">{{ $varian->masuk_lakban2 || $varian->saldo_awal_lakban2 ? $varian->masuk_lakban2 + $varian->saldo_awal_lakban2 : 0 }}</strong>
                    </div>
                    <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                        <strong style="font-size: 20px">Pakai Lakban</strong>
                        <strong
                            style="font-size: 20px">{{ $varian->terpakai_lakban2 ? $varian->terpakai_lakban2 : 0 }}</strong>
                    </div>
                    <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                        <strong style="font-size: 20px">Saldo Akhir</strong>
                    ...
                    <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                        <strong style="font-size: 20px">Reject Lakban</strong>
                        <strong
                            style="font-size: 20px">{{ $varian->reject_lakban2 ? $varian->reject_lakban2 : 0 }}</strong>
                        <strong>{{ $varian->reject_lakban2 ? number_format(($varian->reject_lakban2 / $varian->pakai_lakban2) * 100, 2) : 0 }}
                            %</strong>
                    </div>
                </div>
            </div>
        ...
        <div class="hasil-porduksi-inline">
            ...
            <div class="d-flex flex-wrap gap-3">
                ...
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    ...
                    <strong
                        style="font-size: 20px">{{ $finish_good_liter ? number_format(($finish_good_liter / $volume_mixing) * 100, 2) : 0 }}
                        %</strong>
                </div>
                <div class="card bg-white p-3 shadow-sm" style="border-left: 10px solid #98c1d9">
                    <strong style="font-size: 20px">Reject Rate</strong>
                    <strong
                        style="font-size: 20px">{{ $finish_good == '0' ? '0' : number_format((($actual - $finish_good) / $finish_good) * 100, 2) }}
                        %</strong>
                </div>
            </div>
        </div>
    ...
    <a href="{{ route('export-produksi', $id) }}" class="btn btn-success my-2 mx-1">Export Global <i
            ...
            <tr class="bg-white">
                ...
                <td>
                    <div class="d-md-flex justify-content-center gap-2 d-none">
                        ...
                        <form
                            action="{{ route('batch-list-delete', ['batch_id' => $batch_list->batch_id, 'produksi_id' => $batch_list->produksi_id]) }}"
                            method="POST">
                            @csrf
                            @method('DELETE')
                            ...
                            <a class="btn btn-primary"
                                href="{{ route('batch-list-edit', ['batch_id' => $batch_list->id, 'id' => $id]) }}"><i
