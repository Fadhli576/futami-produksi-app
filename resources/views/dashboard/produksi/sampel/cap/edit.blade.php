...
@section('content')
    <div class="card p-3 mb-5 shadow-sm">
        <h5>Cap</h5>
        <form class="row" action="{{ route('sampel-cap-update', $id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="col-6 col-md-3 botol-cap">
                ...
                <input placeholder="Jumlah Reject" type="text" name="jumlah_cap" value="{{$sampel->jumlah_botol}}" class="form-control">
            </div>
