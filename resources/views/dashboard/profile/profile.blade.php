    ...
    <div class="d-flex justify-content-center">
        <div class="card p-2 p-md-5 mb-5 shadow rounded-5" style="width: 500px">
            ...
            <form method="POST" action="{{ route('update-profile') }}" class="row">
                ...
                <div class="mt-3">
                    <a href="/dashboard" class="btn text-white" style="background-color: #98c1d9"><i class="fa-solid fa-arrow-left-long"></i> Back</a>
                    <button type="submit" class="btn text-white float-end" style="background-color: #98c1d9">Save
                        Changes</button>
                </div>
